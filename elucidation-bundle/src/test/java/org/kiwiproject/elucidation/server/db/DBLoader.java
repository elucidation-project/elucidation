...
public class DBLoader {
    ...
    private static void loadEvents(Jdbi jdbi, CsvMapper mapper, CsvSchema schema) throws IOException {
        ...
        try (var inputStream = url.openStream();
             var iterator = newMappingIterator(mapper, schema, inputStream, ConnectionEvent.class)) {
    ...
    private static void loadTrackedIdentifiers(Jdbi jdbi, CsvMapper mapper, CsvSchema schema) throws IOException {
        ...
        try (var inputStream = url.openStream();
             var iterator = newMappingIterator(mapper, schema, inputStream, TrackedConnectionIdentifier.class)) {
    ...
    private static <T> MappingIterator<T> newMappingIterator(CsvMapper mapper,
                                                             CsvSchema schema,
